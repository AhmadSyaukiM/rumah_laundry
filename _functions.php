...
// new function for transaksi
function del_riwayat_ck($del_ck) {
    global $koneksi;
    mysqli_query($koneksi, "DELETE FROM tb_riwayat_ck WHERE id_ck = '$del_ck'");
    return mysqli_affected_rows($koneksi);
}

function del_riwayat_cs($del_cs) {
    global $koneksi;
    mysqli_query($koneksi, "DELETE FROM tb_riwayat_cs WHERE id_cs = '$del_cs'");
    return mysqli_affected_rows($koneksi);
}

function del_riwayat_dc($del_dc) {
    global $koneksi;
    mysqli_query($koneksi, "DELETE FROM tb_riwayat_dc WHERE id_dc = '$del_dc'");
    return mysqli_affected_rows($koneksi);
}
