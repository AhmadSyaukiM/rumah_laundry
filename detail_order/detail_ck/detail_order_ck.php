               ...
               <div class="card-md">
                  ...
                  <div class="card-body">
                     <form action="" method="post">
                        ...
                        <p class="lead">
                           <textarea id="keterangan_ck" name="keterangan_ck" disabled class="txt-area">
                              <?= $data['keterangan_ck'] ?>
                           </textarea>
                        </p>
                        </div>
                        ...
                        <div class="form-footer_detail">
                           <div class="buttons">
                              <button type="submit" name="bayar_ck" class="btn-sm btn-bayar bg-primary">Bayar Sekarang</button>
                              <a class="btn-sm bg-transparent" href="<?=url('index.php')?>">Kembali</a>
                           </div>
                        </div>
                     </form>
                  </div>
